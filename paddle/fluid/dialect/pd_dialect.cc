...
void PaddleDialect::initialize() {
  ...
  // NOTE(zhangbo9674): GET_PD_DIALECT_OP_LIST is defined in pd_op.h which is
  // generated by op_gen.py, see details in paddle/fluid/dialect/CMakeLists.txt.
  // RegisterOps<GET_PD_DIALECT_OP_LIST>();
